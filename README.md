...
| [`herdr-jutsu`](plugins/herdr-jutsu) | 0.4.0 | this repo | Raise an isolated crew inside Herdr — brief once, wait on a literal pane id, pull bounded results, handle blocked members, and hand long jobs to a fresh session. |
